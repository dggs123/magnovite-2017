...
from .models import RegistrationRC
# Create your views here.

def index(req):

    if settings.DEBUG:
        template = 'magnovite/rightclick.html'
    else:
        template = 'magnovite/rightclick.html'
...
def unregister(req):
    ...
    try:
        reg = RegistrationRC.objects.get(profile=req.user.profile)
        reg.delete()

    except RegistrationRC.DoesNotExist:
        pass
